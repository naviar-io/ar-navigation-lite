...
public class PermissionAppRouter : MonoBehaviour
{
    ...
    public void SwitchToLoading(System.Action OnNotARSupportCallbask = null, System.Action OnNotPermissionsCallback = null,
            System.Action OnSuccessCallback = null)
    {
        var loadingState = stateSwitcher.GetState<LoadingSceneState>();
        loadingState.Init(OnNotARSupportCallbask, OnNotPermissionsCallback, OnSuccessCallback);
