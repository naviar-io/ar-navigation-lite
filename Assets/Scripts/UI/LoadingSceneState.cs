...
namespace ARVRLab.ARNavigation.MockupV3
{
    ...
    {
        private System.Action OnNotARSupportCallbask;
        private System.Action OnNotPermissionsCallback;
        private System.Action OnSuccessCallback; 

        public void Init(System.Action OnNotARSupportCallbask = null, System.Action OnNotPermissionsCallback = null,
            System.Action OnSuccessCallback = null)
        {
            this.OnNotARSupportCallbask = OnNotARSupportCallbask;
        ...
        private IEnumerator StartChecking()
        {
            ...
            while (true)
            {
                ...
                {
                    if (OnNotARSupportCallbask == null)
                    {
                        PermissionAppRouter.Instance.SwitchToNotARSupport();
                    }
                    else
                    {
                        OnNotARSupportCallbask();
                    }
                    yield break;
                }
